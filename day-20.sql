...
FROM 
    cocoa_logs
JOIN break_schedule ON cocoa_logs.break_id = break_schedule.break_id
JOIN cocoa_types ON cocoa_logs.cocoa_id = cocoa_types.cocoa_id
JOIN locations ON break_schedule.location_id = locations.location_id;
